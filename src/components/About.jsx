...
const About = () => {
  return (
    <section id="about" className="autoShow md:pt-[210px] md:-mt-[210px] pt-[240px] -mt-[240px] w-[90%] max-w-6xl mx-auto px-1 sm:px-6 md:px-8 py-8  ">
      <div className=" ">
        ...
        <div className=" flex flex-col md:flex-row md:gap-8 gap-0 items-center">
          ...
          <div>
            ...
            <p className="typingAbout text-gray-400 text-lg text-justify ">
